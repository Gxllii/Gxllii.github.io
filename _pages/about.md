...
* ``TBench'24`` [Characterizing and understanding deep neural network batching systems on GPUs][999]. Feng Yu, Hao Zhang, Ao Chen, Xueying Wang, Xiaoxia Liang, Sheng Wang, **Guangli Li\***, Huimin Cui, Xiaobing Feng. Characterizing and Understanding Deep Neural Network Batching Systems on GPUs, 2024. (Accepted)
